...
const StudentApplication:FC = () => {
    ...
    const [myApplicationsMode, setMyApplicationsMode] = useState(true)
    return (
                ...
                <div className={styles.myApplications_window}>
                    <div className={styles.myApplications_window_content}>
                        <div className={styles.header}>
                            ...
                            <p>Дата</p>
                            <p>Статус</p>
                            <svg onClick={() => setMyApplicationsMode(false)} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    {helloWindow ? (
                        <div className={styles.helloWindow}>
                            <div className={styles.helloWindow_content}>
                                ...
                                <div className={styles.buttons}>
                                    <CancelButton onClick={() => setMyApplicationsMode(true)}>отмена</CancelButton>
                            ...
                            <div className={styles.applyWindow_content}>
                                ...
                                {applyStage === 1 ? (
                                    <div className={styles.applyMain}>
                                        <div onClick={() => setListOpen(!listOpen)} className={styles.list}>
                                        ...
                                        {listOpen ? (
                                            <div className={styles.options}>
                                                <div className={styles.options_content}>
                                                    <div onClick={() => setListOpen(!listOpen)} className={styles.options_block}>Информационные системы и технологии</div>
                                                    <div onClick={() => setListOpen(!listOpen)} className={styles.options_block}>Информационные системы и технологии</div>
                                                    <div onClick={() => setListOpen(!listOpen)} className={styles.options_block}>Информационные системы и технологии</div>
                                                    <div onClick={() => setListOpen(!listOpen)} className={styles.options_block}>Информационные системы и технологии</div>
                                                    <div onClick={() => setListOpen(!listOpen)} className={styles.options_block}>Информационные системы и технологии</div>
                        ...
                        <div className={styles.goodbyeWindow}>
                            <div className={styles.goodbyeWindow_content}>
                                ...
                                <AcceptButton background={'black'} onClick={() => setMyApplicationsMode(true)}>хорошо</AcceptButton>
                            </div>
                        </div>
                    )}
                </>
