...
import {application} from "../../types/ApplicationsResponse";
interface props{
    data:application
}
const ExperienceComponent:FC<props> = ({data}) => {
            ...
            <div className={styles.experience_content}>
                {data.workExperiences.map((work, index) => (
                    <div className={styles.experience_block}>
                        <p className={styles.block_name}>Место работы номер {index + 1}</p>
                        <p className={styles.block_content}>{work.description}</p>
                    </div>
                ))}
